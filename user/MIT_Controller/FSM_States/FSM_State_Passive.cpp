...
FSM_StateName FSM_State_Passive<T>::checkTransition() {
  ...
  // std::cout << "control_mode" << (int)this->_data->controlParameters->control_mode << std::endl;
  // std::cout << "K_TRANSFORM" << K_TRANSFORM << std::endl;
  switch ((int)this->_data->controlParameters->control_mode) {
    ...
    case K_TRANSFORM:
      // Requested switch to joint PD control
      this->nextStateName = FSM_StateName::TRANSFORM;
      break;  
